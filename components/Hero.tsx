      ...
      <div className="wrap hero-grid">
        ...
        <div className="hero-lead">
          ...
          <h1 className="hero-h1">
            Я заменил команду разработчиков ИИ‑агентами. Дальше расту только среди равных.
          </h1>
          <p className="hero-sub">
            Закрытая лаборатория, где ты ведёшь дипломный проект среди практиков своего уровня.
          </p>
