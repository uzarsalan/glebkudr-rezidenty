      ...
      <div className="wrap">
        ...
        <div className="author-card">
          ...
          <blockquote className="author-quote">
            За год я в одиночку запустил 5 проектов и упёрся в стену, о которой обычно молчат: в одиночку рост быстро упирается в потолок. Курсы кончаются — и снова один на один с собой. Поэтому я собираю закрытый круг, где практики ведут свои проекты и держат общий фронтир.
          </blockquote>
