      ...
      <div className="wrap">
        ...
        <div className="author-card">
          ...
          <blockquote className="author-quote">
            За год я в одиночку запустил 5 проектов и упёрся в стену, о которой обычно молчат: в одиночку быстро перестаёшь расти. Курсы я уже прошёл, они кончаются, и ты снова сам по себе. Поэтому я собираю закрытый круг, где практики ведут свои проекты и вместе держат фронтир.
          </blockquote>
