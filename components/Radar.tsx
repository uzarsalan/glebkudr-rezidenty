  ...
  return (
    <section id="radar" className="section section-paper-2">
      <div className="wrap">
        ...
        <h2>Попробуй радар прямо сейчас</h2>
        <p className="lead">
          В потоке ИИ легко пропустить тот самый сдвиг, после которого твой подход устаревает. Этот список ИИ-агент собрал сегодня из 200+ источников и оставил пять вещей, которые действительно важны. В лаборатории такой радар приходит каждый понедельник, чтобы важное ты не пропускал никогда.
        </p>
